...
export class EnHomeComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  private addPersoneSchema() {
    ...
    script.text = JSON.stringify({
      ...
      name: 'Igor Arapov',
      alternateName: ['Игорь Арапов', 'І. В. Арапов'],
      ...
      award: [
        ...
        'Author of a book «Основы трейдинга» (ISBN 979-8-90243-075-9)',
        'Author of a book «Психология трейдинга» (ISBN 979-8-90243-081-0)',
