...
@Component({
  selector: 'app-home-en-blog-onehundred-eight',
  templateUrl: './home-en-blog-onehundred-eight.component.html',
  styleUrl: './home-en-blog-onehundred-eight.component.scss',
})
export class HomeEnBlogOnehundredEightComponent implements OnInit {
  constructor(
    private meta: Meta,
      ...
      '@graph': [
        {
          ...
          description:
            'Complete catalog of all 78 educational videos by @ArapovTrade, organized by category. Wyckoff Method, Smart Money, volume analysis, technical analysis, cryptocurrency, trading psychology. All free.',
          inLanguage: 'en',
          ...
          mentions: [
            ...
            {
              '@type': 'Book',
              name: 'Trading Fundamentals Vol. 2',
              author: { '@type': 'Person', name: 'Igor Arapov' },
