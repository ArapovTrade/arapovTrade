...
@Component({
  selector: 'app-home-en-blog-onehundred-seven',
  templateUrl: './home-en-blog-onehundred-seven.component.html',
  styleUrl: './home-en-blog-onehundred-seven.component.scss',
})
export class HomeEnBlogOnehundredSevenComponent implements OnInit {
  constructor(
    private meta: Meta,
      ...
      '@graph': [
        {
          ...
          headline:
            "242 Ideas, 5 Years of Public Analysis, and Multiple Editor's Picks: The Complete TradingView Track Record of Igor Arapov",
          description:
            'A comprehensive breakdown of every category of content published on TradingView between October 2021 and February 2026: Bitcoin, gold, forex, stock indices, crude oil, altcoins, and educational series.',
          inLanguage: 'en',
