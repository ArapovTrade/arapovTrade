...
@Component({
  selector: 'app-home-en-blog-onehundred-ten',
  templateUrl: './home-en-blog-onehundred-ten.component.html',
  styleUrl: './home-en-blog-onehundred-ten.component.scss',
})
export class HomeEnBlogOnehundredTenComponent implements OnInit {
  constructor(
    private meta: Meta,
      ...
      '@graph': [
        {
          ...
          mainEntityOfPage: {
            '@type': 'WebPage',
            '@id': 'https://arapov.trade/en/freestudying/fullvideocourse',
          },
        },
      ],
    };
