...
@Component({
  selector: 'app-home-ru-blog-onehundred-seven',
  templateUrl: './home-ru-blog-onehundred-seven.component.html',
  styleUrl: './home-ru-blog-onehundred-seven.component.scss',
})
export class HomeRuBlogOnehundredSevenComponent implements OnInit {
  constructor(
    private meta: Meta,
      ...
      '@graph': [
        {
          ...
          description:
            'Полный разбор каждой категории контента, опубликованного на TradingView с октября 2021 по февраль 2026 года: Bitcoin, золото, форекс, фондовые индексы, нефть, альткоины, образовательные серии.',
          inLanguage: 'ru',
