...
ngAfterViewInit() {
  ...
  ngOnInit(): void {
    ...
    this.meta.updateTag({
      name: 'description',
      content: 'Бесплатное обучение трейдингу от Игоря Арапова — полный пошаговый курс с нуля, разбор торговых стратегий, управление рисками и практические занятия. Изучайте трейдинг и криптовалюты дистанционно и бесплатно.',
    });
