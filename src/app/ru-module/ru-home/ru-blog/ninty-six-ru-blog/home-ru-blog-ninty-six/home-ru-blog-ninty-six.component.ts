...
export class HomeRuBlogNintySixComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.titleService.setTitle(
      'Торговля нефтью | Полное руководство трейдера'
    );
    this.meta.updateTag({
      name: 'description',
      content:
      ...
      '@graph': [
        {
          ...
          "description": "Комплексное руководство по торговле нефтью: эталонные сорта WTI и Brent, фундаментальный и технический анализ, инструменты и стратегии для трейдеров.",
  ...
  private setHowToSchema(): void {
    const data = {
      ...
      "@type": "HowTo",
          ...
          "description": "Пошаговое руководство для начинающих трейдеров по освоению нефтяного рынка.",
          "step": [
            {
              "@type": "HowToStep",
              "position": 1,
    ...
    hasDefinedTerm: [
      {
              "@type": "DefinedTerm",
              name: "WTI",
              description: "West Texas Intermediate — американский эталонный сорт нефти, торгуется на бирже NYMEX, служит бенчмарком для североамериканского рынка."
            },
            {
              "@type": "DefinedTerm",
              name: "Brent",
              description: "Эталонный сорт нефти Северного моря, торгуется на ICE, служит международным бенчмарком для ценообразования двух третей мировых контрактов."
            },
            {
              "@type": "DefinedTerm",
              name: "Contango",
              description: "Состояние рынка, когда дальние фьючерсные контракты торгуются дороже ближних, отражая стоимость хранения сырья."
            },
            {
              "@type": "DefinedTerm",
              name: "Backwardation",
              description: "Обратная ситуация contango — дальние фьючерсы дешевле ближних, указывает на текущий дефицит предложения и высокий спрос."
            },
            {
              "@type": "DefinedTerm",
              name: "OPEC+",
              description: "Расширенный альянс стран-экспортёров нефти, координирующий квоты добычи для стабилизации цен на мировом рынке."
            },
            {
              "@type": "DefinedTerm",
              name: "EIA",
              description: "Energy Information Administration — государственное агентство США, публикующее официальную статистику по запасам и потреблению энергоносителей."
            },
            {
              "@type": "DefinedTerm",
              name: "Crack spread",
              description: "Разница между ценой сырой нефти и ценами нефтепродуктов (бензин, дистилляты), отражает маржу нефтепереработчиков."
            },
            {
              "@type": "DefinedTerm",
              name: "OVX",
              description: "Oil Volatility Index — индекс ожидаемой волатильности цен на нефть, аналог VIX для нефтяного рынка."
            },
            {
              "@type": "DefinedTerm",
              name: "Роллирование",
              description: "Процесс переноса позиции с истекающего фьючерсного контракта на следующий для сохранения экспозиции на базовый актив."
            },
            {
              "@type": "DefinedTerm",
              name: "Кушинг",
              description: "Cushing, Oklahoma — ключевой нефтяной хаб США, точка поставки для фьючерсов WTI, индикатор состояния запасов."
            }
    ]
    };
