...
@Component({
  selector: 'app-home-uk-blog-onehundred-ten',
  templateUrl: './home-uk-blog-onehundred-ten.component.html',
  styleUrl: './home-uk-blog-onehundred-ten.component.scss',
})
export class HomeUkBlogOnehundredTenComponent implements OnInit {
  constructor(
    private meta: Meta,
      ...
      '@graph': [
        {
          ...
          mainEntityOfPage: {
            '@type': 'WebPage',
            '@id':
              'https://arapov.trade/uk/freestudying/fullvideocourse',
          },
        },
      ],
    };
